  ...
  return (
    <div className="privacy-container">
      ...
      <article>
        ...
        <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://realn.pl/regulamin">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
        <h2>§1 Definicje</h2>
        <ul>
          <li>
            <p><strong>Serwis</strong> - serwis internetowy "RealN.pl" działający pod adresem https://RealN.pl</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma "RealN Sp.zo.o", prowadząca działalność pod adresem: ul. Lęborska 3B / 80-386 Gdańsk, o nadanym numerze identyfikacji podatkowej (NIP): 5842820195, o nadanym numerze KRS: 0000980444, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis <span>lub Serwisy zewnętrzne</span> podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p>
          </li>
          <li>
        ...
        <ul>
          <li><p>Usprawnienie i ułatwienie dostępu do Serwisu</p></li>
          <li><p>Personalizacja Serwisu dla Użytkowników</p></li>
          <li><p>Umożliwienie Logowania do serwisu</p></li>
          <li><p>Marketing, Remarketing w serwisach zewnętrznych</p></li>
          <li><p>Usługi serwowania reklam</p></li>
          <li><p>Usługi afiliacyjne</p></li>
          <li><p>Prowadzenie statystyk (użytkowników, ilości odwiedzin, rodzajów urządzeń, łącze itp.)</p></li>
          <li><p>Serwowanie usług multimedialnych</p></li>
          <li><p>Świadczenie usług społecznościowych</p></li>
        </ul>
        ...
        <ul>
          <li>
              ...
              <ul>
                <li><p>Usługi rejestracji i utrzymania konta Użytkownika w Serwisie i funkcjonalności z nim związanych</p></li>
                <li><p>Usługi Newslettera (w tym przesyłania za zgodą treści reklamowych)</p></li>
                <li><p>Usługi komentowania / polubienia wpisów w Serwisie bez konieczności rejestrowania się</p></li>
                <li><p>Usługi udostępniania informacji o treści umieszczonych w Serwisie w serwisach społecznościowych lub innych witrynach.</p></li>
              </ul>
              </p>
            </li>
          <li><p>Komunikacji Administratora z Użytkownikami w sprawach związanych z Serwisem oraz ochrony danych</p></li>
          <li><p>Zapewnienia prawnie uzasadnionego interesu Administratora</p></li>
        </ul>
        <p>Dane o Użytkownikach gromadzone anonimowo i automatycznie są przetwarzane w jednym z następujących celów:</p>
        <ul>
          <li><p>Prowadzenie statystyk</p></li>
          <li><p>Remarketing</p></li>
          <li><p>Serwowanie reklam dostosowanych do preferencji Użytkowników</p></li>
          <li><p>Obsługi programów afiliacyjnych</p></li>
          <li><p>Zapewnienia prawnie uzasadnionego interesu Administratora</p></li>
        </ul>
        ...
        <ul>
          <li><p>Adres IP</p></li>
          <li><p>Typ przeglądarki</p></li>
          <li><p>Rozdzielczość ekranu</p></li>
          <li><p>Przybliżona lokalizacja</p></li>
          <li><p>Otwierane podstrony serwisu</p></li>
          <li><p>Czas spędzony na odpowiedniej podstronie serwisu</p></li>
          <li><p>Rodzaj systemu operacyjnego</p></li>
          <li><p>Adres poprzedniej podstrony</p></li>
          <li><p>Adres strony odsyłającej</p></li>
          <li><p>Język przeglądarki</p></li>
          <li><p>Prędkość łącza internetowego</p></li>
          <li><p>Dostawca usług internetowych</p></li>
        </ul>
        <p><strong>Dane gromadzone podczas rejestracji:</strong></p>
        <ul>
          <li><p>Imię / nazwisko / pseudonim</p></li>
          <li><p>Login</p></li>
          <li><p>Adres e-mail</p></li>
          <li><p>Avatar / Zdjęcie profilowe</p></li>
          <li><p>Adres zamieszkania</p></li>
          <li><p>Płeć</p></li>
          <li><p>Data urodzenia / wiek</p></li>
          <li><p>Adresy do profili społecznościowych</p></li>
          <li><p>Numer telefonu</p></li>
          <li><p>Adres IP (zbierane automatycznie)</p></li>
          <li><p>Numer NIP</p></li>
          <li><p>Inne dane zwykłe</p></li>
        </ul>
        ...
        <ul>
          <li><p>Imię i nazwisko / pseudonim</p></li>
          <li><p>Adres e-mail</p></li>
          <li><p>Adres www</p></li>
          <li><p>Adres IP (zbierane automatycznie)</p></li>
        </ul>
        ...
        <ul>
          <li><p>Firmy hostingowe, świadczące usługi hostingu lub usług pokrewnych dla Administratora</p></li>
          <li><p>Firmy, za pośrednictwem których świadczona jest usługa Newslettera</p></li>
        </ul>
        <p><strong>Powierzenie przetwarzania danych osobowych - Newsletter</strong></p>
        <p>Administrator w celu świadczenia usługi Newsletter, korzysta z usług podmiotu trzeciego - serwisu <strong><a rel="nofollow external" href="https://mailchimp.com/legal/privacy/">MailChimp</a>, <a rel="nofollow external" href="https://legal.hubspot.com/privacy-policy">HubSpot</a>, </strong>. Dane wprowadzone w formularzu zapisu do newslettera są przekazywane, przechowywane i przetwarzane w serwisie zewnętrznym tego usługodawcy.</p>
        ...
        <ul>
          <li><p>Dane osobowe nie będą przekazywane poza Unię Europejską, chyba że zostały opublikowane na skutek indywidualnego działania Użytkownika (np. wprowadzenie komentarza lub wpisu), co sprawi, że dane będą dostępne dla każdej osoby odwiedzającej serwis.</p></li>
          <li><p>Dane osobowe nie będą wykorzystywane do zautomatyzowanego podejmowania decyzji (profilowania).</p></li>
          <li><p>Dane osobowe nie będą odsprzedawane podmiotom trzecim.</p></li>
        </ul>
        <p><strong>Dane anonimowe (bez danych osobowych) gromadzone automatycznie:</strong></p>
        <ul>
          <li><p>Dane anonimiwe (bez danych osobowych) będą przekazywane poza Unię Europejską.</p></li>
          <li><p>Dane anonimiwe (bez danych osobowych) nie będą wykorzystywane do zautomatyzowanego podejmowania decyzji (profilowania).</p></li>
          <li><p>Dane anonimiwe (bez danych osobowych) nie będą odsprzedawane podmiotom trzecim.</p></li>
        </ul>
        ...
        <ul>
          ...
          <li><p>Ustawa z dnia 10 maja 2018 r. o ochronie danych osobowych (Dz.U. 2018 poz. 1000)</p></li>
          <li><p>Ustawa z dnia 16 lipca 2004 r. Prawo telekomunikacyjne (Dz.U. 2004 nr 171 poz. 1800)</p></li>
          <li><p>Ustawa z dnia 4 lutego 1994 r. o prawie autorskim i prawach pokrewnych (Dz. U. 1994 Nr 24 poz. 83)</p></li>
        </ul>
        ...
        <ul>
          <li>
            <p><strong>Adres pocztowy</strong> - RealN Sp.zo.o, ul. Lęborska 3B / 80-386 Gdańsk</p>
          </li>
          <li>
            <p><strong>Adres poczty elektronicznej</strong> - info@realn.pl</p>
          </li>
          <li>
            <p><strong>Połączenie telefoniczne</strong> - +48 668 001 756</p>
          </li>
          <li>
